...
### ForgeLoop 1.9.0 adaptive efficiency, Structural Quality, and boundary surfaces
...
`1.9.0` Integration API v1 (canonical ownership, durable recovery,
...
- Vitest
- Playwright
- `@cassiomc1/forgeloop` 1.9.0 (vendored from the trusted source commit in `schemas/provenance.json`, read-only)
...
The current vendored ForgeLoop baseline is ForgeLoop `1.9.0` at immutable source commit `64dca84357d11989d16b0698e1ff6409ff0f0ddf` (protocol v1, schema v1, Integration API v1).
