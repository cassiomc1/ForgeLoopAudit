...
`1.10.2` Integration API v1 (canonical ownership, durable recovery,
...
- Vitest
- Playwright
- `@cassiomc1/forgeloop` 1.10.2 (vendored from the trusted source commit in `schemas/provenance.json`, read-only)
...
The current vendored ForgeLoop baseline is ForgeLoop `1.10.2` at immutable source commit `d286e1983177a0dfb1f0ceef6c2f6e30c406303a` (protocol v1, schema v1, Integration API v1).
